...
ALTER TABLE assignment_files ADD COLUMN file_type VARCHAR(20) DEFAULT 'SUBMISSION';
...
CREATE INDEX idx_assignment_files_file_type ON assignment_files(file_type);
