...
export default function AdminPageHeader({ title, subtitle, label = "Quản trị hệ thống", actions }: AdminPageHeaderProps) {
  return (
    <header className="mb-6 animate-fade-in">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 shadow-[0_18px_40px_rgba(15,23,42,0.12)] px-6 py-4 sm:px-8 sm:py-5 transition-all duration-300">
