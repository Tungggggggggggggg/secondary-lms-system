      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="text-xs font-semibold text-muted-foreground">Thông báo bảo trì (tuỳ chọn)</div>
            <Textarea
        ...
        <Card className="p-6 space-y-4">
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="text-sm font-semibold text-foreground">Global announcement</div>
              <div className="text-xs text-muted-foreground mt-1">
          ...
          <div className="space-y-2">
            <div className="text-xs font-semibold text-muted-foreground">Nội dung thông báo</div>
            <Textarea
