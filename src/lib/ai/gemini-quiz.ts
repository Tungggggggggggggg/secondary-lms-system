...
export async function generateQuizFromText(
  ...
  const systemPrompt = [
    ...
    "",
    "Quy tắc:",
    "- Mỗi câu hỏi có CHÍNH XÁC 4 đáp án lựa chọn.",
    "- CHỈ MỘT đáp án đúng cho mỗi câu hỏi (dạng trắc nghiệm 1 đáp án đúng).",
    "- Đánh dấu đáp án đúng bằng [x], đáp án sai bằng [ ].",
    "- Đáp án đúng có thể nằm ở vị trí bất kỳ trong 4 đáp án (A, B, C hoặc D).",
