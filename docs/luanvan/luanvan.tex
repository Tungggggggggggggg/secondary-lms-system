...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \coordinate (TL) at ($(current page.north west) + (2.5cm, -1.0cm)$);
    \coordinate (BR) at ($(current page.south east) + (-1.0cm, 1.0cm)$);

    \draw [line width=0.8pt] (TL) rectangle (BR);
    
    \draw [line width=2.5pt] ($(TL) + (0.2cm, -0.2cm)$) rectangle ($(BR) + (-0.2cm, 0.2cm)$);
\end{tikzpicture}
    \centering
    {\large \textbf{BỘ GIÁO DỤC VÀ ĐÀO TẠO}} \\
    {\large \textbf{TRƯỜNG ĐẠI HỌC GIAO THÔNG VẬN TẢI TP.HCM}} \\
    {\large \textbf{VIỆN CÔNG NGHỆ THÔNG TIN VÀ ĐIỆN, ĐIỆN TỬ}}
    
    \vspace{1.5cm}
    \begin{figure}[h]
      \centering
      \IfFileExists{docs/luanvan/figures/uth-logo.png}{
        \includegraphics[width=0.5\textwidth]{docs/luanvan/figures/uth-logo.png}
      }{
        \IfFileExists{figures/uth-logo.png}{
          \includegraphics[width=0.5\textwidth]{figures/uth-logo.png}
        }{
    ...
    \vspace{1.5cm}
    {\Large \textbf{LUẬN VĂN TỐT NGHIỆP}} \\
...
\begin{tabular}{@{}l l@{}}
  ...
  \begin{tabular}[t]{@{}l@{}}
    \textbf{Nguyễn Quốc Tùng - 2251120259} \\
    \textbf{Nguyễn Võ Thành - 2251120246}
  \end{tabular} \\
...
Trong bối cảnh cuộc Cách mạng công nghiệp 4.0, chuyển đổi số trong giáo dục không còn là một lựa chọn mà đã trở thành xu thế tất yếu. Sự bùng nổ của Trí tuệ nhân tạo tạo sinh (Generative AI) đang tái định hình cách thức con người tiếp cận tri thức, chuyển dịch từ mô hình học tập thụ động sang học tập chủ động và cá nhân hóa.

Tuy nhiên, tại Việt Nam, phần lớn các Hệ thống Quản lý học tập (LMS) hiện hành vẫn dừng lại ở vai trò là kho lưu trữ tài liệu số hóa, thiếu đi sự tương tác thông minh và khả năng thấu hiểu người học. Điều này tạo ra một "điểm nghẽn" trong việc nâng cao chất lượng đào tạo trực tuyến, đặc biệt là trong việc hỗ trợ giải đáp thắc mắc tức thời và đảm bảo tính liêm chính trong thi cử.

Xuất phát từ thực tiễn đó và niềm đam mê công nghệ, chúng tôi thực hiện đề tài: \textbf{"Nghiên cứu và xây dựng hệ thống quản lý học tập thông minh (Smart LMS) dựa trên kiến trúc RAG và mô hình ngôn ngữ lớn"}. Đề tài không chỉ là một nhiệm vụ tốt nghiệp, mà còn là nỗ lực của chúng tôi trong việc kiến tạo một hệ sinh thái giáo dục mang tên \textbf{EduVerse} -- nơi AI đóng vai trò là người trợ giảng tận tụy (AI Tutor) và là giám thị công tâm, giúp thu hẹp khoảng cách giữa công nghệ và giáo dục thực tiễn.

Chúng tôi hy vọng rằng, kết quả nghiên cứu này sẽ đóng góp một góc nhìn mới về ứng dụng Generative AI trong trường học, hướng tới một môi trường giáo dục thông minh, hiệu quả và minh bạch hơn.
...
Để hoàn thành luận văn tốt nghiệp này, bên cạnh sự nỗ lực của bản thân, chúng tôi đã nhận được sự quan tâm, động viên và hướng dẫn tận tình từ quý Thầy Cô, gia đình và bạn bè.

Lời đầu tiên, chúng tôi xin gửi lời tri ân sâu sắc nhất đến \textbf{ThS. Bùi Trọng Hiếu}. Thầy không chỉ là người trực tiếp hướng dẫn, định hướng đề tài mà còn là người đã truyền cảm hứng, khắt khe trong tiêu chuẩn khoa học và tận tâm chỉ bảo chúng tôi trong từng bước đi của dự án. Những lời khuyên quý báu và sự kiên nhẫn của Thầy chính là kim chỉ nam giúp nhóm vượt qua những thách thức kỹ thuật để hoàn thiện hệ thống \textbf{EduVerse}.

Chúng tôi xin trân trọng cảm ơn Ban Giám hiệu, cùng quý Thầy Cô thuộc \textbf{Viện Công nghệ thông tin và Điện, điện tử -- Trường Đại học Giao thông vận tải TP.HCM}. Môi trường học tập năng động và những kiến thức nền tảng vững chắc mà quý Thầy Cô đã truyền đạt trong suốt những năm qua là hành trang vô giá để chúng tôi thực hiện đề tài này.

Cuối cùng, chúng tôi xin dành lời cảm ơn chân thành đến gia đình và những người bạn đã luôn là hậu phương vững chắc, luôn thấu hiểu và sẻ chia những khó khăn trong suốt quá trình thực hiện luận văn.

Mặc dù đã nỗ lực hết mình với tinh thần cầu thị nghiêm túc, song do giới hạn về thời gian và kiến thức, luận văn khó tránh khỏi những thiếu sót. Chúng tôi kính mong nhận được những ý kiến đóng góp quý báu từ quý Thầy Cô trong Hội đồng và các bạn để đề tài được hoàn thiện và phát triển tốt hơn trong tương lai.
...
Lựa chọn Gemini 2.5 Flash Lite \cite{gemini} không chỉ dựa trên hiệu năng mà còn dựa trên tính kinh tế và kỹ thuật:
\begin{itemize}
...
Kiến trúc RAG (Retrieval-Augmented Generation) là giải pháp trọng tâm để loại bỏ hiện tượng "ảo tưởng" (hallucination) của AI \cite{rag}.
...
Hệ thống sử dụng phần mở rộng \texttt{pgvector} \cite{pgvector} trên PostgreSQL để thực hiện các phép toán không gian.
...
\begin{itemize}
    \item \textbf{Next.js 14 (App Router)\cite{nextjs}:} Tối ưu hóa Rendering phía máy chủ (SSR) để giảm thời gian phản hồi trang đầu tiên (TTFB).
    \item \textbf{Prisma ORM\cite{prisma}:} Đảm bảo tính an toàn về kiểu dữ liệu (Type-safety), ngăn chặn các lỗi logic tại tầng truy cập dữ liệu.
    \item \textbf{Supabase Ecosystem\cite{supabase}:} Cung cấp hạ tầng Backend-as-a-Service (BaaS) giúp quản lý tập trung từ Storage, Database đến Auth, giúp hệ thống có khả năng mở rộng (Scalability) linh hoạt.
\end{itemize}
...
\section{So sánh và lựa chọn giải pháp công nghệ}
Để đảm bảo hệ thống EduVerse đáp ứng các yêu cầu về hiệu năng và tính toàn vẹn dữ liệu, nhóm nghiên cứu đã thực hiện so sánh các giải pháp lưu trữ vector và mô hình ngôn ngữ trước khi đi đến quyết định cuối cùng.

\subsection{Lựa chọn cơ sở dữ liệu Vector}
Bảng \ref{tab:vector-db-comparison} trình bày so sánh giữa việc sử dụng cơ sở dữ liệu vector chuyên dụng (như Pinecone/Milvus) và giải pháp tích hợp PostgreSQL với pgvector.

\begin{table}[H]
\centering
\small
\caption{So sánh giải pháp lưu trữ Vector}
\label{tab:vector-db-comparison}
\begin{tabularx}{\textwidth}{|p{3.5cm}|X|X|}
\hline
\textbf{Tiêu chí} & \textbf{Database Vector chuyên dụng (VD: Pinecone)} & \textbf{PostgreSQL + pgvector (Đã chọn)} \\ \hline
Kiến trúc & Tách biệt, cần đồng bộ dữ liệu. & Tích hợp sẵn trong RDBMS. \\ \hline
Tính toàn vẹn (ACID) & Khó đảm bảo tính nhất quán giữa dữ liệu nghiệp vụ và vector. & Đảm bảo ACID, join trực tiếp giữa bảng vector và bảng Users/Lessons. \\ \hline
Chi phí & Tốn kém chi phí duy trì hạ tầng riêng. & Tận dụng hạ tầng CSDL sẵn có, tối ưu chi phí. \\ \hline
\end{tabularx}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{figures/uml/png/usecase-overall.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{figures/ui/ch4-auth.png}
  \caption{Minh họa màn hình đăng nhập của hệ thống}
  \label{fig:ch4-auth}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{figures/ui/ch4-select-role.png}
  \caption{Minh họa màn hình lựa chọn vai trò (RBAC) trước khi truy cập portal}
...
\centering
\small
\caption{Độ tin cậy ghi nhận ExamEvent (kết quả thực nghiệm S2)}
...
\hline
\path{POST /api/exam-events} (S2) & 200 & 200 & 100\% \\
\hline
\end{tabular}
\endgroup
\end{table}
...
\section{Giá trị mang lại và điểm khác biệt so với các hệ thống LMS phổ biến}
Bên cạnh việc hiện thực hoá các chức năng LMS truyền thống (quản lý lớp học, học liệu, bài tập và giao tiếp), hệ thống EduVerse được định hướng như một \textbf{Smart LMS} tập trung vào (i) tăng cường tương tác học tập dựa trên tri thức nội bộ và (ii) hỗ trợ đảm bảo liêm chính trong đánh giá trực tuyến. Từ đó, hệ thống mang lại giá trị thực tiễn cho các nhóm người dùng chính như sau.

\subsection{Lợi ích theo nhóm người dùng}
\begin{itemize}
  \item \textbf{Học sinh (Student):} nhận được hỗ trợ hỏi đáp theo ngữ cảnh học liệu của lớp thông qua AI Tutor (RAG), giúp giảm thời gian ``kẹt kiến thức'' ngoài giờ học và tăng tính chủ động; câu trả lời kèm nguồn tham chiếu giúp người học kiểm chứng và học đúng trọng tâm.
  \item \textbf{Giáo viên (Teacher):} giảm tải các câu hỏi lặp lại nhờ AI Tutor; có công cụ giám sát thi dựa trên nhật ký sự kiện và điểm nghi ngờ, đồng thời có bản tóm tắt AI phục vụ rà soát nhanh thay vì phải đọc log thô.
  \item \textbf{Phụ huynh (Parent):} có kênh theo dõi tiến độ/điểm số và nhận thông tin tổng hợp, tăng khả năng phối hợp giữa gia đình và nhà trường trong việc hỗ trợ học tập.
  \item \textbf{Quản trị viên (Admin):} quản trị người dùng, lớp học và phân quyền rõ ràng theo RBAC; tăng khả năng kiểm soát vận hành và chuẩn hoá truy cập tài nguyên.
\end{itemize}

\subsection{Điểm khác biệt so với các hệ thống tương tự}
So với các hệ thống LMS phổ biến vốn tập trung vào lưu trữ học liệu và quản lý quy trình giao--nộp bài, EduVerse có một số điểm khác biệt trọng tâm:
\begin{itemize}
  \item \textbf{AI Tutor theo kiến trúc RAG (grounded):} thay vì sinh câu trả lời theo tri thức chung, hệ thống truy xuất ngữ cảnh từ kho học liệu nội bộ (pgvector) và trả lời kèm danh sách nguồn tham chiếu, qua đó giảm rủi ro ``ảo tưởng'' và tăng độ tin cậy trong môi trường giáo dục.
  \item \textbf{Chống gian lận dựa trên sự kiện (event-driven) và diễn giải cho giáo viên:} hệ thống ghi nhận hành vi trong quá trình làm bài, tính điểm nghi ngờ theo cơ chế rule-based (có giới hạn theo từng nhóm hành vi) và cung cấp bản tóm tắt AI hỗ trợ giáo viên ra quyết định nhanh, thay vì chỉ áp dụng biện pháp chặn cứng nhắc.
  \item \textbf{Kiểm soát vận hành và chi phí AI:} các endpoint AI áp dụng rate-limit theo IP và theo người dùng nhằm hạn chế lạm dụng và kiểm soát chi phí; tách các tác vụ nặng (như indexing) theo hướng tối ưu trải nghiệm.
\end{itemize}

\subsection{Bằng chứng định lượng về khả năng vận hành}
Kết quả đo thực nghiệm ở Chương 5 cung cấp bằng chứng định lượng cho khả năng vận hành của các luồng trọng tâm:
\begin{itemize}
  \item \textbf{Luồng AI Tutor (E1):} độ trễ P95 xấp xỉ \textbf{5.45s} với tỉ lệ lỗi \textbf{0\%} (Bảng \ref{tab:experiment-results}). Độ trễ cao hơn là phù hợp với bản chất phụ thuộc dịch vụ AI và truy vấn CSDL từ xa.
  \item \textbf{Luồng ghi nhận ExamEvent (E2):} độ trễ P95 xấp xỉ \textbf{1.40s}, tỉ lệ lỗi \textbf{0\%} và độ tin cậy ghi nhận \textbf{100\%} (Bảng \ref{tab:experiment-results} và Bảng \ref{tab:exam-event-reliability}), cho thấy hệ thống có thể xử lý tần suất sự kiện cao một cách ổn định.
  \item \textbf{Luồng Anti-cheat AI Summary (E3):} độ trễ P95 xấp xỉ \textbf{6.31s} với tỉ lệ lỗi \textbf{0\%} (Bảng \ref{tab:experiment-results}), phản ánh mức độ phù hợp cho tác vụ ``diễn giải'' phục vụ giáo viên.
\end{itemize}
...
\chapter{Liên kết dự án và triển khai}
Mã nguồn và triển khai tham khảo:

\begin{itemize}
  \item \textbf{GitHub repository:} \url{https://github.com/Tungggggggggggggg/secondary-lms-system}
  \item \textbf{Deploy (Vercel):} \url{https://secondary-lms-system.vercel.app/}
\end{itemize}

\chapter{Một số giao diện Dashboard theo vai trò}
Phần này cung cấp một số ảnh chụp màn hình (screenshot) nhằm minh họa giao diện dashboard tương ứng với từng vai trò trong hệ thống.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/ui/appendix-dashboard-admin.png}
  \caption{Dashboard vai trò Admin}
  \label{fig:appendix-dashboard-admin}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/ui/appendix-dashboard-teacher.png}
  \caption{Dashboard vai trò Teacher}
  \label{fig:appendix-dashboard-teacher}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/ui/appendix-dashboard-student.png}
  \caption{Dashboard vai trò Student}
  \label{fig:appendix-dashboard-student}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/ui/appendix-dashboard-parent.png}
  \caption{Dashboard vai trò Parent}
  \label{fig:appendix-dashboard-parent}
\end{figure}
